-- Migration: 003_structure_lock.sql
-- Schema Hardening & Sovereign 60 Reset

-- 1. USER HABITS TABLE: Ensure Support for Frequency/Colors
ALTER TABLE habits ADD COLUMN IF NOT EXISTS frequency TEXT DEFAULT 'daily';
ALTER TABLE habits ADD COLUMN IF NOT EXISTS base_color TEXT DEFAULT '#6366F1';
...
ALTER TABLE habits ADD COLUMN IF NOT EXISTS unit TEXT DEFAULT 'rep';
...
-- 2. LIBRARY TABLE: Ensure Support
...
ALTER TABLE maximost_library_habits ADD COLUMN IF NOT EXISTS frequency TEXT DEFAULT 'daily';

-- 3. LIBRARY RESET: Truncate to fix ghost IDs
TRUNCATE TABLE maximost_library_habits CASCADE;
