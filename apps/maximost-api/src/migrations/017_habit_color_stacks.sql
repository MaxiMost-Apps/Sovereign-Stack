...
-- Red (Intensity)
UPDATE atoms SET color = '#EF4444' WHERE slug IN ('heavy-lifting', 'zone-2-cardio', 'cold-plunge');

-- Green (Recovery)
UPDATE atoms SET color = '#10B981' WHERE slug IN ('sauna', 'intermittent-fasting', 'meditation', 'sleep-protocol');
