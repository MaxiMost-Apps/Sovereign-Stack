...
def run():
    with sync_playwright() as p:
        ...
        # 1. Verify Adaptive Colors (Daily View)
        # We can't easily check colors without complex DOM analysis, but we can verify the element structure changes
        print("Taking daily view screenshot...")
        page.screenshot(path="verification_daily_adaptive.png")

        # 2. Verify Weekly Matrix Adaptive Colors & Bars
        ...
        page.screenshot(path="verification_weekly_adaptive.png")
