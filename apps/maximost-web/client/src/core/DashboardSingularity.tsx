...
import { WeeklyMatrix } from '@/components/dashboard/WeeklyMatrix'; // Now exists!
          ...
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-md text-[10px] font-bold tracking-widest transition-all ${
                view === tab.id ? 'bg-slate-700 text-white shadow-lg' : 'text-slate-500 hover:text-white hover:bg-white/5'
              }`}
            >
