          ...
          return (
              <div key={t.id} onClick={async () => {
                  ...
                  <div className="flex justify-between items-start mb-4">
                      <div className={`w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center ${t.base_color?.replace('bg-', 'text-') || 'text-slate-500'}`}>
                          <Icon size={20} />
                      </div>
                  ...
                  <p className="text-xs text-slate-500 line-clamp-2 mb-4">{t.lenses?.FORTITUDE?.why || "Standard Protocol."}</p>
