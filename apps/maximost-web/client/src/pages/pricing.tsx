  ...
  const tiers = [
    {
      ...
      price: "$14.99",
      period: "per month",
      description: "The standard operating procedure for dedicated self-improvement.",
      features: [
    ...
    },
    {
      ...
      price: "$199.00",
      period: "one-time",
      description: "Lifetime access for the Founding 500 members.",
      features: [
        "LIFETIME Access (No fees)",
        "Founding 500 Status",
        "1 Scholarship Generated",
        "Priority Voting Rights",
        "All Monthly Features",
        "Grandfathered AI Access"
      ],
      buttonText: "Join The Vanguard",
      href: "/signup?plan=vanguard",
      highlighted: true
    },
    {
      ...
      price: "$149.99",
      period: "per year",
      description: "Commit to the long game. Save 17%.",
      features: [
        "All Monthly Features",
    ...
    },
    {
      ...
      price: "$499.00",
      period: "lifetime",
      description: "The Anchor Tier. Equity in the system.",
      features: [
        "Everything in Vanguard",
        "Direct Line to Core Team",
        "Feature Bounty Voting",
        "Architect Badge",
        "1-on-1 Strategy Session"
      ],
      buttonText: "Become Sovereign",
